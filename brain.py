...
def create_save_journal_tool(update_callback):
    ...
    def save_journal_entry(mood: str, energy: int, note: str):
        ...
        return f"✅ Recorded: Mood={mood}, Energy={energy}"
...
def create_set_plan_tool(update_callback):
    ...
    def set_full_plan(vision: str, system: str):
        ...
        return f"✅ Plan updated and saved!\n🔭 Vision: {vision}\n⚙️ System: {system}\n💾 Saved to: {profile_path} and {csv_path}\n\n💡 Tip: Starter will dynamically generate micro-action suggestions based on your current state."
...
class SupervisorDecision(BaseModel):
    ...
    reasoning: str = Field(
        ...,
        description="Your reasoning process, following 3-step analysis: Step 1 (Analyze Intent) → Step 2 (Check Context) → Step 3 (Apply Rules). Briefly explain your thinking process."
    )
...
"""
        ...
        # Has Vision but no System → Ask for System
        context = f"""
...
"""
        ...
        # Both exist → Regular conversation, can show different greetings
        import datetime
